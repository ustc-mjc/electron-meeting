...
const Navigation = ({isOpen, toggleSidebar} : {isOpen: boolean, toggleSidebar: (arg: boolean) => void}) => {
    ...
    return (
        <nav className="flex items-center justify-between w-full flex-wrap p-3 bg-green-600">
            <div className="flex items-center flex-shrink-0 text-white text-xl font-mono">
                ...
                <span className="font-semibold tracking-tight ml-4">Meeting</span>
                {meeting.loginInfo.loginState && (
                    <div className="ml-6">
                        <svg className="inline-block" xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 0 24 24" width="30px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/></svg>
                        <span className="ml-2 text-base">{meeting.loginInfo.username}</span>
                    </div>  
                )}
            ...
            <div className="flex items-center">
                <div className="flex items-center w-60">
                    {meetingRecorded ? (<div className="text-yellow-200 mr-4">正在录制</div>) : ''}
