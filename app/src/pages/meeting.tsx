...
import {leaveMeeting, muteMic, unmuteMic, videoOff, videoOn, screenOff, screenOn} from "../slices/meeting";
                ...
                <div className="flex flex-wrap h-full ">
                    <div className="flex-1 flex flex-col max-h-full max-w-full">
                        ...
                        <div className="flex flex-row justify-center gap-x-3 py-4 bg-white-400">
                            ...
                            <button className="bg-white rounded-full shadow-xl p-4 focus:outline-none" onClick={toggleScreen}>
                                {
                            ...
                            <button className="bg-red-600 rounded-full shadow-xl p-4 focus:outline-none" onClick={() => {
